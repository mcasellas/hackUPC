...
#define MIN_TILT_STEP 0 // The lowest TILT step value that is allowed (hardware min is 140, DO NOT GO ALL THE WAY TO THIS VALUE!)
#define MAX_TILT_STEP 1023 // The lowest TILT step value that is allowed (hardware max is 866, DO NOT GO ALL THE WAY TO THIS VALUE!)
...
{
  ax12SetRegister2 ( PAN , AX_GOAL_SPEED_L , pan);
  ax12SetRegister2 ( TILT , AX_GOAL_SPEED_L , tilt);
